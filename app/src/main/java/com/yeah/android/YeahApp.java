 ...
 * on 2015/7/6.
 */
public class YeahApp extends Application {
    ...
    public static YeahApp getApp() {
        if (mInstance != null && mInstance instanceof YeahApp) {
            return (YeahApp) mInstance;
        } else {
            mInstance = new YeahApp();
            mInstance.onCreate();
            return (YeahApp) mInstance;
        }
    }
