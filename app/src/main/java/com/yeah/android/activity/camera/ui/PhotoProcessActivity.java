...
public class PhotoProcessActivity extends CameraBaseActivity {
    ...
    private void initEvent() {
        ...
        labelSelector.setTxtClicked(v -> {
            EditTextActivity.openTextEdit(PhotoProcessActivity.this,"",8, Constants.ACTION_EDIT_LABEL);
        });
        labelSelector.setAddrClicked(v -> {
            EditTextActivity.openTextEdit(PhotoProcessActivity.this,"",8, Constants.ACTION_EDIT_LABEL_POI);
