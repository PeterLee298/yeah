...
import com.yeah.android.view.drawable.EditableDrawable;
import com.yeah.android.view.drawable.FeatherDrawable;
import com.yeah.android.YeahApp;
import com.yeah.android.R;
import com.imagezoom.ImageViewTouch;
import com.yeah.android.activity.camera.util.Point2D;
import com.yeah.android.activity.camera.util.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = YeahApp.getApp().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = YeahApp.getApp().getResources().getDrawable(R.drawable.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(YeahApp.getApp().dp2px(1));
